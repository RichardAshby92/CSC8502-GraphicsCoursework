...
Plants::Plants(Vector3 heightmapSize) {
	...
	//load Files
	plant = Mesh::LoadFromMeshFile("P_Bush05.msh");
	plantMat = new MeshMaterial("P_Bush05.mat");
	...
	tree->SetTransform(Matrix4::Translation(heightmapSize * Vector3(0.3f, 0.65f, 0.65f)));
	tree->SetTexture(1);
